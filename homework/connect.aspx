...
<script runat="server">
    ...
    Response.Write("<h1> Connect Sucessfull </h1>");
        ...
        Response.Write("<h1> Connect erro </h1>");
    }

    private void showData(){
        string strCon= "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\asp\dbasp3CW2.accdb;User Id=;Password=;";
...
<body>
    <form id="f1" runat="server">
       ...
       <Columns>
        ...
        <asp:BoundColumn HeaderText="Last Name" DataField="Surname" />
        <asp:BoundColumn HeaderText="Gender" DataField="Gender" />
        <asp:BoundColumn HeaderText="Major" DataField="MajorID" />
